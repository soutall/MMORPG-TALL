...
window.desenharCajadoLuzExposta = function(ctx, armaVisualCustom) {
    ...
    // An�is cerimoniais dourados na haste
    ...
    // Cabe�a do Staff: Coroa solar alada sustentando o orbe de luz
    ...
    // Mini aur�ola dourada na coroa do cajado
    ...
    // ------------------------------------------------------------------------
    // ORBE DE PURA LUZ SAGRADA (N�CLEO RADIANTE + RAIOS EM CRUZ + CENTELHAS)
    // ------------------------------------------------------------------------
    ...
    // N�cleo branco incandescente de luz pura
    ctx.fillStyle = '#ffffff';
    ctx.beginPath();
