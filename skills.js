...
const SKILLS_INFO = {
    ...
    dronemaster: [
        { id: 'drone_dm', nome: 'Disparo do Drone', icon: '🔫', categoria: 'ataque',
          desc: 'O Drone Companheiro dispara um tiro de energia à distância (290px).',
          danoBase: 13, danoUnidade: 'físico', danoNota: null,
          mp: 0, cd: 0.7, escala: 'dano',
          area: 'Linha de tiro (290px)', alcance: 'À distância',
          duracao: null, duracaoBase: null, extras: [] },
        ...
        { id: 'caixa_dm', nome: 'Caixa de Ferramentas', icon: '🧰', categoria: 'zona',
          desc: 'Coloca uma caixa de ferramentas no chão por 10s: aliados próximos recebem ESCUDO de 50% da vida máxima (não acumula).',
          danoBase: null, danoUnidade: null, danoNota: 'Escudo 50% vida máx',
          mp: 30, cd: 15, escala: 'buff',
          area: 'Caixa raio 100', alcance: 'Lança até 200px',
          duracao: '10s', duracaoBase: 10, extras: ['Escudo só uma vez por aliado', 'Não sobrescreve escudos ativos'] },
    ...
    // ===== ARQUEIRO ARCANO (v1.31): os 4 elementos encadeados =====
    arqueiro_arcano: [
        { id: 'flecha_arcana', nome: 'Flecha Arcana', icon: '🏹', categoria: 'ataque',
          desc: 'Flecha elemental rápida que volta para a mão (500ms). Alterna visualmente entre os elementos.',
          danoBase: 16, danoUnidade: 'mágico', danoNota: null,
          mp: 0, cd: 0.5, escala: 'dano',
          area: 'Linha (260px)', alcance: 'À distância',
          duracao: null, duracaoBase: null, extras: [] },
        { id: 'fenix_fogo', nome: 'Flecha Fênix', icon: '🔥', categoria: 'zona',
          desc: 'Dispara uma flecha de fogo que explode: dano de impacto + deixa o CHÃO EM CHAMAS por 4s.',
          danoBase: 22, danoUnidade: 'mágico', danoNota: '+ fogo 4s',
          mp: 25, cd: 7, escala: 'dano',
          area: 'Explosão raio 70 + chamas 4s', alcance: 'Até 300px',
          duracao: '4s', duracaoBase: 4, extras: ['Chão em chamas por 4s'] },
        { id: 'poca_gelo', nome: 'Poça Congelante', icon: '🧊', categoria: 'zona',
          desc: 'Cria uma poça congelante que CONGELA os inimigos por 2s; ao descongelar, causa dano de quebra do gelo.',
          danoBase: 26, danoUnidade: 'mágico', danoNota: 'roga freeze 2s',
          mp: 25, cd: 8, escala: 'dano',
          area: 'Poça raio 85', alcance: 'Até 260px',
          duracao: '2s', duracaoBase: 2, extras: ['Freeze 2s', 'Dano ao descongelar'] },
        { id: 'onda_vento', nome: 'Onda de Vento', icon: '🌪️', categoria: 'aoe',
          desc: 'Sopra uma onda de vento que IMPEDE o movimento dos inimigos atingidos por 2s (root).',
        ...
        { id: 'tornado_fogo', nome: 'Tornado de Fogo (Combo)', icon: '🔥🌪️', categoria: 'aoe',
          desc: 'COMBO: Flecha Fênix → Poça Congelante (2s): combina fogo e gelo criando um tornado de fogo por 5s com dano contínuo.',
          danoBase: 14, danoUnidade: 'mágico', danoNota: 'via combo',
          mp: 0, cd: 0, escala: 'dano',
          area: 'Tornado raio 85', alcance: 'Região das skills',
          duracao: '5s', duracaoBase: 5, extras: ['Combinação fogo+gelo', 'Dano contínuo'] },
        { id: 'poco_glacial', nome: 'Poço Glacial (Combo)', icon: '🧊🌀', categoria: 'aoe',
          desc: 'COMBO: Poça Congelante → Onda de Vento (2s): cria um poço glacial que PUxA (pull) os inimigos para o centro, congela e causa dano contínuo por 5s.',
          danoBase: 16, danoUnidade: 'mágico', danoNota: 'pull + freeze',
          mp: 0, cd: 0, escala: 'dano',
          area: 'Poço raio 130', alcance: 'Região das skills',
          duracao: '5s', duracaoBase: 5, extras: ['Puxa inimigos para o centro', 'Congela dentro do poço'] }
    ],
    ...
    sniper: [
        ...
        { id: 'arame_rede', nome: 'Arame Prendedor', icon: '🕸️', categoria: 'zona',
          desc: 'Arremessa um arame que PRENDE o primeiro inimigo atingido no lugar por 3s (não pode se mover).',
          danoBase: null, danoUnidade: null, danoNota: 'Root 3s',
          mp: 15, cd: 10, escala: 'buff',
          area: 'Ataque único (60px)', alcance: 'Até 320px',
          duracao: '3s', duracaoBase: 3, extras: ['Pega o primeiro inimigo'] },
...
const NOMES_CLASSES = {
    ...
    dronemaster: 'DRONEMASTER', arqueiro_arcano: 'ARQUEIRO ARCANO', sniper: 'SNIPER'
};
